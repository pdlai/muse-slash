const beatMap = {
    ...
    layout: [
        ...
        { count: 35, step: 2.25, zone: "bot"},
        { count: 35, step: 2.5, zone: "bot"},
        { count: 35, step: 3, zone: "bot"},
        { count: 35, step: 3.25, zone: "bot"},
        { count: 35, step: 3.75, zone: "bot"},
        { count: 35, step: 4, zone: "bot"},
        { count: 35, step: 4.5, zone: "bot"},
        { count: 35, step: 4.75, zone: "bot"},
        { count: 35, step: 5, zone: "top"},
        { count: 35, step: 5.25, zone: "top"},
        { count: 35, step: 5.5, zone: "top"},
        { count: 35, step: 5.75, zone: "top"},
        { count: 35, step: 6, zone: "bot"},
        { count: 35, step: 6.5, zone: "bot"},
        { count: 35, step: 7, zone: "top"},
        { count: 35, step: 7.25, zone: "top"},
        { count: 35, step: 7.5, zone: "top"},
        { count: 35, step: 8, zone: "bot"},
        { count: 35, step: 8.25, zone: "bot"},
        { count: 35, step: 8.33, zone: "bot"},
        { count: 35, step: 8.75, zone: "bot"},
